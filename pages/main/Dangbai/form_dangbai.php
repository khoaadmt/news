...
<body>
    ...
    <section class="contact-section">
        <div class="container">
                    ...
                    <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                        <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                            ...
                            <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
                                <a target="_blank" rel="noopener" href="https://maps.google.com/maps?ll=-31.197,150.744&amp;z=9&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3" title="Open this area in Google Maps (opens a new window)" style="position: static; overflow: visible; float: none; display: inline;">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Hãy đăng bài viết tâm sự</h2>
                </div>
                <div class="col-lg-8">
                <form method="post" action="" enctype="multipart/form-data" id="post-form" >
                    ...
                    <div class="wd">
                        ...
                        <input type="text" name="tieuDeBaiViet" placeholder="tiêu đề">    
                    </div>                          
                    <div class="wd">
                    ...
                    <di class="wd">
                        ...
                        <textarea rows="5" name="linkVideo" placeholder="Nhập link video"></textarea>
                    </di>
                    <di class="wd">
                        <label>Tóm tắt</label>
                    ...
                    <div class="bt">
                        <input class="them" type="submit" name="themBaiViet" value="Thêm">
